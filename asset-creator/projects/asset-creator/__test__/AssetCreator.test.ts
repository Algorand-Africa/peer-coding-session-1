...
import { AssetCreatorClient, AssetCreatorFactory } from '../contracts/clients/AssetCreatorClient';

const fixture = algorandFixture();
Config.configure({ populateAppCallResources: true });

let appClient: AssetCreatorClient;
...
describe('AssetCreator', () => {
  ...
  beforeAll(async () => {
    ...
    const factory = new AssetCreatorFactory({
      algorand,
